<section class="">
    ...
    <form method="post" action="{{ route('strategies.update', $strategy) }}" class="mt-6 space-y-6">
        @csrf
        @method('put')
        ...
        <div>
            ...
            <x-select-input id="symbol_id" name="symbol_id" class="mt-1 block w-full" required>
                <option value="{{ $strategy->symbol_id }}">{{ $strategy->symbol->name }}</option>
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" required autocomplete="strategies name" :value="old('name', $strategy->name)"/>
         ...
         <div>
            ...
            <x-text-input id="rr" name="rr" type="text" class="mt-1 block w-full" required autocomplete="RR" :value="old('rr', $strategy->rr)"/>
        ...
        <div>
            ...
            <x-text-input id="timeframe" name="timeframe" type="text" class="mt-1 block w-full" required autocomplete="timeframe"  :value="old('timeframe', $strategy->timeframe)"/>
